...
import AddBalanceForm from "../../components/Forms/AddBalanceForm/AddBalanceForm/AddBalanceForm";
...
export default function Home() {
  ...
  const [categoryCount, setCategoryCounts] = useState({
    food: 0,
    entertainment: 0,
    travel: 0,
  });
  ...
  useEffect(() => {
    const localBalance = localStorage.getItem("balanace");

    if (localBalance) {
      setBalance(Number(localBalance));
    } else {
      setBalance(5000);
      localStorage.setItem("balanace", 5000);
    }
